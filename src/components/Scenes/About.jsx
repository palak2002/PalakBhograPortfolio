...
Experienced Backend Software Developer with a proven track record in designing, implementing, and optimizing robust server-side solutions. Proficient in Python and Java, adept at database management, API integration, and ensuring scalable, high-performance applications. Strong collaborator in cross-functional teams, dedicated to delivering efficient and reliable backend systems. 
            </motion.p>
            <motion.p
              className="text-nd-white text-base sm:text-xl text-justify"
              initial="hidden"
              ...
              grow. If you know any good opportunity that matches with my skills
              and{" "}
              <Link
