    ...
    <div className="w-full md:w-10 md:fixed md:bottom-0 md:left-2 lg:left-4 xl:left-7 md:right-auto md:z-10">
      <motion.ul className="flex flex-row md:flex-col items-center justify-center m-0 p-0 gap-5">
        <motion.li
          ...
          <a href="https://github.com/palak2002" target="_blank">
            <GitHub />
          </a>
        </motion.li>
        <motion.li
          ...
          <a href="https://www.linkedin.com/in/palak-bhogra-8b92791bb/" target="_blank">
            <LinkedIn />
          </a>
        </motion.li>
        <motion.li
          ...
          <a href="http://instagram.com/palakintechland" target="_blank">
            <Instagram />
          </a>
        </motion.li>
        <motion.li
